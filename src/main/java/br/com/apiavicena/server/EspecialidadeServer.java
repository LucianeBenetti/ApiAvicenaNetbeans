...
public class EspecialidadeServer {
    ...
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    @Path("{codigoEspecialidade}")
    public EspecialidadeVO getEspecialidadeVO(@PathParam("codigoEspecialidade") Integer id) {
        EspecialidadeDAO especialidadeDAO = new EspecialidadeDAO();
    ...
    @Path("{codigoEspecialidade}")
    public Boolean alterar(@PathParam("codigoEspecialidade") Integer id, @FormParam("dado") String dadosJSON) {
        Gson gson = new Gson();
        EspecialidadeVO especialidadeVO = gson.fromJson(dadosJSON, EspecialidadeVO.class);

        if (id == especialidadeVO.getCodigoEspecialidade() || especialidadeVO.getCodigoEspecialidade() == null) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Path("{codigoEspecialidade}")
    public Boolean deletar(@PathParam("codigoEspecialidade") Integer id) {
        EspecialidadeDAO especialidadeDAO = new EspecialidadeDAO();
